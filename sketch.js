...
mainCyclist.setCollider("rectangle",0,300,1200,500);
...
function pinkCyclists(){
        ...
        player1.setCollider("rectangle",0,300,1200,500)
        player1.depth = mainCyclist.depth-1
pinkCG.add(player1);
...
function yellowCyclists(){
        ...
        player2.setCollider("rectangle",0,300,1200,500)
        player2.setLifetime=170;
player2.depth = mainCyclist.depth-1
...
function redCyclists(){
        ...
        player3.setCollider("rectangle",0,300,1200,500);
player3.depth = mainCyclist.depth-1
redCG.add(player3);
}
